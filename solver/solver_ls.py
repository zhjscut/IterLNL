...
class SolverLS(solver_IterLNL):
    ...
    def __init__(self, model, dataloaders, evaluator, cfg):
        ...
        self.criterions = {"SmoothCELoss": SmoothCELoss(self.cfg.label_smooth, self.cfg.num_classes),
                           }
    ...
    def get_pseudo_label_of_target_data(self):
        ...
        _, pseudo_labels = torch.max(soft_label, dim=1)
    ...
    def train_a_new_target_model(self):
        ...
        for self.iter in range(1, self.actual_max_iters + 1):
            ...
            loss_C = self.criterions["SmoothCELoss"](logit, gt)
